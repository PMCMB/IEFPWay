            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 text">
                        <h1><strong>IEFPWay</strong> Top up</h1>
                    ...
                    <div class="col-sm-6 col-sm-offset-3 form-box">
                        ...
                        <div class="form-bottom">
                            <form role="form"  method="post" class="login-form">
                                ...
                                $_SESSION["id_cartao"] = mysqli_fetch_assoc($r)["card_id"];//VARIAVEL DE SESSAO COM O ID DO CARTAO
                                ...
                                $sql->bind_param("d", $_SESSION["id_cartao"]);
                                $sql->execute();
                                ...
                                if(isset($_POST["form-value"])){
                                    ...
                                    $sql->bind_param("dd", $valorTotal, $_SESSION["id_cartao"]);
                                    $sql->execute();
